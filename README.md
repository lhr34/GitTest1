...
|--------|--------|--------|--------|--------|
|Hengrui Lu 2865255|25%|Backend: implement power control features: auto control, manual control, simple control; sensor and dataset generating; ML model training for auto control; <br>Frontend: power control panel; sensor data display; power consumption graph; <br>Other: README file|        |Hengrui Lu|
